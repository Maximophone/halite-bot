...
def main(old_model_file,new_model_file):
    ...
    cv0 = Convolution2D(32,3,3,border_mode='same')(input_)
    bn0 = BatchNormalization()(cv0)
    act0 = Activation("relu")(bn0)

    cv1 = AtrousConvolution2D(64,3,3,atrous_rate=(2,2),border_mode='same')(act0)
    bn1 = BatchNormalization()(cv1)
    act1 = Activation("relu")(bn1)

    cv2 = AtrousConvolution2D(128,3,3,atrous_rate=(4,4),border_mode='same')(act1)
    bn2 = BatchNormalization()(cv2)
    act2 = Activation("relu")(bn2)

    cv3 = AtrousConvolution2D(64,3,3,atrous_rate=(8,8),border_mode='same')(act2)
