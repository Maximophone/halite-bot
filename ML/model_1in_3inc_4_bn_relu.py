...
def main(old_model_file,new_model_file):
    ...
    cv0_1 = Convolution2D(4,1,1,border_mode='same')(input_)
    cv0_3 = Convolution2D(8,3,3,border_mode='same')(input_)
    cv0_11 = Convolution2D(4,11,11,border_mode='same')(input_)

    merged_0 = merge([cv0_1, cv0_3, cv0_11], mode='concat')
    bn0 = BatchNormalization()(merged_0)
    act0 = Activation("relu")(bn0)

    cv1_1 = Convolution2D(4,1,1,border_mode='same')(act0)
    cv1_3 = Convolution2D(8,3,3,border_mode='same')(act0)
    cv1_11 = Convolution2D(4,11,11,border_mode='same')(act0)

    merged_1 = merge([cv1_1, cv1_3, cv1_11], mode='concat')
    bn1 = BatchNormalization()(merged_1)
    act1 = Activation("relu")(bn1)

    cv2_1 = Convolution2D(4,1,1,border_mode='same')(act1)
    cv2_3 = Convolution2D(8,3,3,border_mode='same')(act1)
    cv2_11 = Convolution2D(4,11,11,border_mode='same')(act1)

    merged_2 = merge([cv2_1, cv2_3, cv2_11], mode='concat')
    bn2 = BatchNormalization()(merged_2)
    act2 = Activation("relu")(bn2)

    cv3 = Convolution2D(32,3,3,border_mode='same')(act2)
    bn3 = BatchNormalization()(cv3)
    act3 = Activation("relu")(bn3)

    cv4 = Convolution2D(64,3,3,border_mode='same')(act3)
    bn4 = BatchNormalization()(cv4)
    act4 = Activation("relu")(bn4)

    cv4 = Convolution2D(128,3,3,border_mode='same')(act3)
    bn4 = BatchNormalization()(cv4)
    act4 = Activation("relu")(bn4)

    output = Convolution2D(5,3,3,activation='relu',border_mode='same')(act4)
